...
export const TABLES: Table[] = [
  ...
  { id: 2, tableName: 'Interview', columnName: ["select", "ID", "Interview Code", "Interview Name", "Description", "Download", ""], columns: ["select", 'interviewId', "interviewCode", "interviewName", "description", "download", "update"] },
